  ...
  return (
    <section className="relative overflow-hidden pt-8 pb-16 sm:pt-14 sm:pb-24 lg:pt-16 lg:pb-32">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10 flex items-center justify-center">
        ...
        <div className="absolute top-0 h-[450px] w-[800px] rounded-full bg-gradient-to-b from-amber-100/40 via-orange-50/20 to-transparent blur-3xl opacity-70" />
        {/* Bottom glowing aura */}
        <div className="absolute -bottom-20 h-[350px] w-[90vw] max-w-[1100px] rounded-full bg-gradient-to-t from-amber-200/35 via-amber-100/20 to-transparent blur-3xl opacity-80" />
      </div>
