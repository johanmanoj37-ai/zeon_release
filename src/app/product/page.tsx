...
const WINDOWS_DOWNLOAD_URL = "https://pub-2eaefafb3b7549059373fad40f311534.r2.dev/Zeon-1.2.2-Installer.exe";
const ANDROID_APK_DOWNLOAD_URL = "https://pub-2eaefafb3b7549059373fad40f311534.r2.dev/Zeon-V1.2.2.apk";
            ...
            <div className="relative flex flex-col justify-between rounded-3xl border border-[#E8E6DF] bg-white p-8 sm:p-10 shadow-hero-mockup transition-all hover:border-[#D5D0C5] hover:shadow-xl">
              ...
              <div className="mt-8 pt-6 border-t border-[#EFECE6]">
                <a
                  ...
                  download="Zeon-1.2.2-Installer.exe"
